...
-- INGRESAR USUARIOS
------------------------------------------------------------
INSERT INTO USUARIO(ID_USUARIO, NOMBRE_USUARIO, TIPO, CONTRASENIA) VALUES (1515, 'ANTONIA', 'ASISTENTE', 123);
------------------------------------------------------------
-- INGRESAR BARCOS
------------------------------------------------------------

INSERT INTO EMBARCACION(ID_EMBARCACION, ID_ASISTENTE, TIPOEMBARCACION, PRECIO, PATENTE) VALUES(001, 123, 'YATE', 1000000, '1111');
INSERT INTO EMBARCACION(ID_EMBARCACION, ID_ASISTENTE, TIPOEMBARCACION, PRECIO, PATENTE) VALUES(002, 123, 'YATE', 1000000, '2222');
INSERT INTO EMBARCACION(ID_EMBARCACION, ID_ASISTENTE, TIPOEMBARCACION, PRECIO, PATENTE) VALUES(003, 123, 'BARCO', 500000, '3333');
INSERT INTO EMBARCACION(ID_EMBARCACION, ID_ASISTENTE, TIPOEMBARCACION, PRECIO, PATENTE) VALUES(004, 123, 'BARCO', 500000, '4444');

-------------------------------------------------------------
---INSERTAR CLIENTE
-------------------------------------------------------------
INSERT INTO CLIENTE(RUT, ID_USUARIO, NOMBRECLIENTE, DIRECCION,TELEFONO) VALUES(7952209, 6515165, 'JOSE ROJAS VERGARA', 'CLIENTE' , 'LOS ALMENDROS 0110', 945641234);
INSERT INTO CLIENTE(RUT, ID_USUARIO, NOMBRECLIENTE, DIRECCION,TELEFONO) VALUES(19472440, 0148793125, 'CAMILA SEPULVEDA ROCO', 'CLIENTE', 'ROSAS 302',974145782);
INSERT INTO CLIENTE(RUT, ID_USUARIO, NOMBRECLIENTE, DIRECCION,TELEFONO) VALUES(11208575, 0174159832, 'ANA ABARZUA ROJAS', 'CLIENTE', 'MIGUEL CARRERA 004', 97854143);
INSERT INTO CLIENTE(RUT, ID_USUARIO, NOMBRECLIENTE, DIRECCION,TELEFONO) VALUES(17091192, 0145277529, 'ANDRES ASTORGA RUIZ', 'CLIENTE', 'AV. STA MARIA 105', 956412486);


-------------------------------------------------------------
---INSERTAR ASISTENTE 
-------------------------------------------------------------
INSERT INTO ASISTENTE(ID_ASISTENTE, ID_USUARIO, RUT, NOMBREASISTENTE, DIRECCION, TELEFONO) VALUES(123, 1515, 16456258, 'ANTONIA DIAZ VERGARA','COLO COLO 1456', 957254821);
INSERT INTO ASISTENTE(ID_ASISTENTE, ID_USUARIO, RUT, NOMBREASISTENTE, DIRECCION, TELEFONO) VALUES(124, 124, 17415230, 'LUIS JORQUERA CANALES','RENGO 245', 957211421);
INSERT INTO ASISTENTE(ID_ASISTENTE, ID_USUARIO, RUT, NOMBREASISTENTE, DIRECCION, TELEFONO) VALUES(125, 125, 18714351, 'ANTONIO FUENTE MONTALBA','INDEPENDECIA 153', 974243521);


-------------------------------------------------------------
---INSERTAR SEGURO
-------------------------------------------------------------
INSERT INTO SEGURO(ID_SEGURO, ID_EMBARCACION, VALORSEGURO) VALUES(02456,001,100000);
INSERT INTO SEGURO(ID_SEGURO, ID_EMBARCACION, VALORSEGURO) VALUES(02457,002,100000);
INSERT INTO SEGURO(ID_SEGURO, ID_EMBARCACION, VALORSEGURO) VALUES(02458,003,150000);
INSERT INTO SEGURO(ID_SEGURO, ID_EMBARCACION, VALORSEGURO) VALUES(02459,004,150000);
