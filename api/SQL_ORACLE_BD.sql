...
BEGIN
    ...
    IF (PRECIO_EMBARACACION > 0) THEN
        SELECT PRECIO INTO PRECIO_SEGURO FROM SEGURO WHERE ID_EMBARCACION = H_ID_EMBARACION;
        NUEVO_ID := CREATE_ID_PAGO.NEXTVAL;
        INSERT INTO PAGO VALUES(NUEVO_ID, PRECIO_EMBARCACION+PRECIO_SEGURO, H_TIPO);
        COMMIT;
        RESULTADO   :=  'TRUE';
        MENSAJE     :=  NUEVO_ID;
